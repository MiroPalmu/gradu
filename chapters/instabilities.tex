...
1925~\citep{langmuir_scattering_1925,briggs_electron-stream_1964}.
Later, in 1948, Pierce explained Langmuir's observations by demonstrating
that unstable oscillations can arise in such systems \citep{pierce_possible_1948}.
...
become unstable~\citep{fried_mechanism_1959}.
...
an anisotropic, two-temperature Maxwellian plasma~\citep{weibel_spontaneously_1959}.
...
Following the symbolic-calculator technique from \citep{bret_beam-plasma_2007},
...
and velocities are sampled from Jüttner-Synge distribution~\citep{zenitani_loading_2015}
