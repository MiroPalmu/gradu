...
Figure \ref{missing} plots the normalized growth rate (i.e. imaginary part of $x$)
as a function of $\ve$ for two different cases.
...
\begin{align}
  ...
  \epsilon_{xz} &= \frac{Z_x \alpha}{x^3} \left( \gamma_p - \gamma_b \right)
\end{align}
