...
$\left(\lambda_D/L\right)^2$~\cite{wiesemann_short_2014,hazeltine_framework_2018}.
...
and written as~\cite{kilpula_2017}:
\begin{align}
...
and $n_s(\mathbf{x}, t)$
is its number density~\cite{bret_multidimensional_2010,bret_collective_2004}.
...
and the linearized momentum transport equations~\cite{bret_collective_2004,bret_cfa_2012}:
\begin{align}
...
or the Courant number for short~\cite{verboncoeur_particle_2005}.
...
\begin{table}
  ...
  \caption{Summary of different limits for the numerical dispersion
    relation from Equation~\eqref{eq:fd-dispersion}~\cite{verboncoeur_particle_2005}.}
