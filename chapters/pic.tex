...
\begin{align}
  ...
  \pm \hat{c}
  \begin{bmatrix}
    \rho^T_{N,M+\frac12,L} - \rho^T_{N,M-\frac12,L}
    - \left(\nu^T_{N,M,L+\frac12} - \nu^T_{N,M,L-\frac12}\right) \\
    \mu^T_{N,M,L+\frac12} - \mu^T_{N,M,L-\frac12}
    - \left(\rho^T_{N+\frac12,M,L} - \rho^T_{N-\frac12,M,L}\right) \\
    \nu^T_{N+\frac12,M,L} - \nu^T_{N-\frac12,M,L}
    - \left(\mu^T_{N,M+\frac12,L} - \mu^T_{N,M-\frac12,L}\right)
  \end{bmatrix}
\end{align}
...
\begin{split}
  ...
  & - \hat{c}
  \begin{bmatrix}
    E^{s}_{n,m+1,l+\frac12} - E^{s}_{n,m,l+\frac12}
    - \left(E^{s}_{n,m+\frac12,l+1} - E^{s}_{n,m+\frac12,l}\right) \\
    E^{s}_{n+\frac12,m,l+1} - E^{s}_{n+\frac12,m,l}
    - \left(E^{s}_{n+1,m,l+\frac12} - E^{s}_{n,m,l+\frac12}\right) \\
    E^{s}_{n+1,m+\frac12,l} - E^{s}_{n,m+\frac12,l}
    - \left(E^{s}_{n+\frac12,m+1,l} - E^{s}_{n+\frac12,m,l}\right)
  \end{bmatrix}
\end{split}
\end{equation}
...
\begin{split}
  ...
  & + \hat{c}
  \begin{bmatrix}
    B^{s+\frac12}_{n+\frac12,m+\frac12,l} - B^{s+\frac12}_{n+\frac12,m-\frac12,l}
    - \left(B^{s+\frac12}_{n+\frac12,m,l+\frac12} - B^{s+\frac12}_{n+\frac12,m,l-\frac12}\right) \\
    B^{s+\frac12}_{n,m+\frac12,l+\frac12} - B^{s+\frac12}_{n,m+\frac12,l-\frac12}
    - \left(B^{s+\frac12}_{n+\frac12,m+\frac12,l} - B^{s+\frac12}_{n-\frac12,m+\frac12,l}\right) \\
    B^{s+\frac12}_{n+\frac12,m,l+\frac12} - B^{s+\frac12}_{n-\frac12,m,l+\frac12}
    - \left(B^{s+\frac12}_{n,m+\frac12,l+\frac12} - B^{s+\frac12}_{n,m-\frac12,l+\frac12}\right)
  \end{bmatrix}
\end{split}
\end{equation}
...
do not contain values that would not be present on a Yee mesh.
