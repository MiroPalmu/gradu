...
\end{tikzpicture}
\end{minipage}
\caption{Scheme for the current integrals in Villasenor-Buneman method.
  Dashed cell is the Yee mesh cell and the solid cell is the staggered grid
  on which the charge is conserved.
  Left:
  The blue and red boxes denotes the overlap of a particle charge before and after its movement.
  Right:
  The initial overlap is moved where it ends up after the particle has moved.
  The orange surfaces despict the integrated areas in derivation of Villasenor-Buneman method.
}
