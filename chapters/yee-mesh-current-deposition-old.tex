...
\end{minipage}
\caption{
  Visualization of the current integrals calculated in the Villasenor-Buneman method.
  ...
  Left: The blue and red boxes denote the particle's charge contribution
  arising from its overlap with the solid cell before and after its movement.
