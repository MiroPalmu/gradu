...
\end{tikzpicture}
\caption{The twelve faces through which a moving particle generates
  current fluxes in the Villasenor-Buneman method.
  The Yee mesh cell in which the particle trajectory is confined
