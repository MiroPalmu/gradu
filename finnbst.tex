...
\def\bblphdthesis{v�it�skirja}
\def\bblfirst{ensimm�inen}
\def\bblfirsto{1.}
\def\bblsecond{toinen}
\def\bblsecondo{2.}
\def\bblthird{kolmas}
\def\bblthirdo{3.}
\def\bblfourth{nelj�s}
\def\bblfourtho{4.}
\def\bblfifth{viides}
\def\bblfiftho{5.}
\def\bblst{.}
...
\def\bbldec{joulukuu}
\def\bblins{sarjassa} % Oma lis�ys: "in" series.
\def\bblinj{julkaisussa} % Oma lis�ys: "in" journal.
%%
%%
