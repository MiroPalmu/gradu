...
\def\bbleditors{redakt�rer}
\def\bbleds{red.}
\def\bbleditor{redakt�r}
\def\bbled{red.}
\def\bbledby{redigerad av}
\def\bbledition{utg�va}
\def\bbledn{utg.}
\def\bblvolume{volym}
\def\bblvol{vol.}
\def\bblof{ur serien}
...
\def\bblfirst{f�rsta}
\def\bblfirsto{f�rsta}
\def\bblsecond{andra}
\def\bblsecondo{andra}
\def\bblthird{tredje}
\def\bblthirdo{tredje}
\def\bblfourth{fj�rde}
\def\bblfourtho{fj�rde}
\def\bblfifth{femte}
\def\bblfiftho{femte}
...
\def\bblins{i serie} % Oma lis�ys: "in" series.
\def\bblinj{i journalen} % Oma lis�ys: "in" journal.
%%
%%
